describe(
  "Автотест на указание этапов и режима выполнения участков ",
  function () {
    ...
    it("1. Переходим по URL /#/my_tasks_wc_for_test. Ждём загрузки и убеждаемся, что отобразилась таблица ##can_continue",
      async (done) => {
    ...
    it(
      '2. Выбираем наряд "Указать этапы и режим выполнения участков ремонта пути" и открываем его. Убеждаемся, что запись открылась, в ней есть вкладки, поля и кнопка "Сохранить".  ##can_continue',
      async (done) => {
    ...
    it("5. Кликаем по ссылке и убеждаемся что отобразилась таблица и в ней имеются не менее 3х записей. ##can_continue",
      async (done) => {
    ...
    it(
      '7. Проверить, что есть кнопки "Указать этап" и  "Указать режим выполнения", выбрать запись, нажать на кнопку "Указать этап",  ##can_continue',
      async (done) => {
    ...
    it(
      '10. Вернуться к задаче и нажать на кнопку Выполнить. Убедиться, что значение поля статус изменился на "Выполнен". ##can_continue',
      async (done) => {
