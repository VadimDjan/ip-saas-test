describe('Настройка доступа переходов ЖЦ В доставку и Завершение', function() {
  ...
  it('Настройка прав перехода у ЖЦ В доставку', async done => {
    ...
    await errorCatcher(async () => {
      ...
      await browser.sleep(2000);
      // await element(by.css('th[data-title="Имя"]')).click();
      // await browser.sleep(2000);
      ...
      await browser.sleep(2000);
      await element(by.cssContainingText('div[data-field-name="accessobjectsn"] .rw-popup-container ul li', 'Менеджеры')).click();
