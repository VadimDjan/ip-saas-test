describe('Добавление таблицы Заказ', function () {
    ...
    it('add new row', async done => {
      await errorCatcher(async () => {
        ...
        await element(by.css('.list-wrapper .idea-grid .k-header .idea-button-add-row-modal')).click(); // idea-button-add-row
        ...
        await browser.sleep(200);
        // используем существующий формат
        await element(by.css('div[data-field-name="_$_FF/useexistingformat"] .checkboxfield__checkbox')).click();
        await browser.sleep(200);
        // выберем тлф в формате поля
        await element(by.css('div[data-field-name="fieldformatid"] .comboboxfield__container')).click();
        await browser.sleep(2000);
        await element(by.cssContainingText('div[data-field-name="fieldformatid"] .rw-popup-container ul li', 'Телефон')).click();
        await browser.sleep(2000);
        // кн Создать поле
        await element(by.cssContainingText('button', 'Создать поле')).click();
        await browser.wait(EC.stalenessOf($('[data-button-name="CREATE"] .loader-spinner')), defaultWaitTimeout);
        ...
        // Поле Плавающий формат
        await sidebar[2].click();
        await browser.sleep(2000);
        const floatingRow = await element.all(by.css('.form-designer__sidebar-group[open] .form-designer__control-wrapper')).get(3);
        await browser.executeScript(dnd, floatingRow, form);
        await browser.wait(EC.presenceOf(element(by.cssContainingText('.form-header__title', 'Поле'))), defaultWaitTimeout);
        await browser.sleep(1000);
        // пишем название
        await element(by.css('.form-header__title .glyphicon-pencil')).click();
        await browser.sleep(2000);
        await element(by.css('.displayname__name_active')).sendKeys('Плавающий формат');
        await browser.sleep(2000);
        await element(by.css('.displayname .glyphicon-ok')).click();
        await browser.sleep(2000);
        // задаем полю системное имя
        await element(by.css('div[data-field-name="fieldname"] input')).sendKeys('test_floating');
        await browser.sleep(1000);
        // кн Создать поле
        await element(by.cssContainingText('button', 'Создать поле')).click();
        await browser.wait(EC.stalenessOf($('[data-button-name="CREATE"] .loader-spinner')), defaultWaitTimeout);
        ...
        await browser.actions().mouseDown(timeRow).mouseMove({ x: 600, y: -60 }).mouseUp().perform();
        await browser.sleep(2000);
        // подвинем на форме поле Адрес
        const addressRow = await element(by.css('div[data-field-name="address"]'));
        await browser.actions().mouseDown(addressRow).mouseMove({ x: -600, y: 0 }).mouseUp().perform();
        await browser.sleep(2000);
        ...
        await browser.actions().mouseDown(othersRow).mouseMove({ x: -600, y: 0 }).mouseUp().perform();
        await browser.sleep(2000);
        // подвинем на форме поле Особенности
        const specsRow = await element(by.css('div[data-field-name="is_condition"]'));
        await browser.actions().mouseDown(specsRow).mouseMove({ x: 300, y: 0 }).mouseUp().perform();
        await browser.sleep(2000);
        ...
        await browser.actions().mouseDown(managerRow).mouseMove({ x: -600, y: 0 }).mouseUp().perform();
        await browser.sleep(2000);
        // подвинем на форме поле Сопроводительные документы
        const docsRow = await element(by.css('div[data-field-name="documents"]'));
        await browser.actions().mouseDown(docsRow).mouseMove({ x: 500, y: 0 }).mouseUp().perform();
        await browser.sleep(2000);
        ...
        await browser.sleep(2000);
        await element(by.cssContainingText('.rw-popup-container ul li', 'manager1')).click();
        await browser.sleep(2000);
        await element(by.css('div[data-field-name="phone"] input')).clear().sendKeys('+7(789)4561230');
        await browser.sleep(200);
        ...
        await element(by.css('div[data-field-name="customer"]')).click();
        await browser.sleep(2000);
        await element.all(by.css('.rw-popup-container ul li span')).last().click();
        await browser.sleep(2000);
        await element(by.css('div[data-field-name="phone"] input')).clear().sendKeys('+7(456)7891230');
        await browser.sleep(200);
        ...
        await browser.sleep(200);
        await element(by.css('div[data-field-name="phone"] input')).clear().sendKeys('+7(741)8529630');
        await browser.sleep(200);
        await element(by.css('div[data-field-name="customer"]')).click();
        await browser.sleep(2000);
        await element(by.cssContainingText('.rw-popup-container ul li', 'manager1')).click();
        ...
        await browser.sleep(2000);
        await element.all(by.css('.k-animation-container ul li')).last().click();
        await browser.sleep(1000);
